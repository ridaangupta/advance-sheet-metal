      ...
      <section className="relative text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-100 animate-fade-in [animation-delay:0.2s]">Transform your space with custom ductwork and premium HVAC sheet metal solutions!</p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => <Card key={index} className="service-card overflow-hidden animate-fade-in" style={{ animationDelay: `${0.1 * (index + 1)}s` }}>
